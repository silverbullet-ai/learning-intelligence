...
# installed.
TCL_PREFIX='A:/Nexus/Coding/Data Science & AI/learning-intelligence/pyvenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='A:/Nexus/Coding/Data Science & AI/learning-intelligence/pyvenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='A:/Nexus/Coding/Data Science & AI/learning-intelligence/pyvenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IA:/Nexus/Coding/Data Science & AI/learning-intelligence/pyvenv\Library\include'
...
TCL_PACKAGE_PATH='A:/Nexus/Coding/Data Science & AI/learning-intelligence/pyvenv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LA:/Nexus/Coding/Data Science & AI/learning-intelligence/pyvenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='A:/Nexus/Coding/Data Science & AI/learning-intelligence/pyvenv\Library\lib\tclstub86.lib'
